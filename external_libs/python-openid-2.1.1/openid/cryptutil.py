...
try:
    import hashlib
    import hashlib.sha256 # This is used to ensure that we have the full hashlib implementation. It is a temporary support for Pypy, until it moves to version 2.5
except ImportError:
