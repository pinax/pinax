...
write_png("test2.png", 50, 90, gradient([
    ...
    (1.0,  (0x66, 0x66, 0x66), (0xFF, 0xFF, 0xFF)), # shadown
]))

# header background from pinax
write_png("test3.png", 50, 80, gradient([
    (0.722222, (0x00, 0x26, 0x4D), (0x00, 0x40, 0x80)),
    (1.0,  (0x00, 0x40, 0x80), (0x00, 0x6C, 0xCF)), # glow
]))

# form background from pinax
write_png("test5.png", 50, 25, gradient([
    (0.33, (0xDD, 0xDD, 0xDD), (0xF3, 0xF3, 0xF3)),
